...
<script type="text/javascript" src="resources/script/eventosBotao.js"></script>
	<title>Identificação sem Audio</title>
	<style type="text/css">
		body    {background-image:url(resources/images/fundoprincipal.jpg);background-position:400px 90px;background-repeat:no-repeat;background-attachment:no-fixed;background-size:800px 1000px;}

	</style>
</head>
<body>
<img src="resources/images/banner_topo.gif"  width="1590" />
...
<div id="contato" name="contato" style="position:absolute;left:250px;top:324px;"  onmousedown="javascript:linkContato()">
	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"  codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="60" height="60">
...
<div id="quem" name="quem" style="position:absolute;left:490px;top:324px;" onmousedown="javascript:linkQuemSomos()" >
	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"  codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="60" height="60">
...
<div id="ajuda" name="ajuda" style="position:absolute;left:720px;top:324px;" >
	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"  codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="60" height="60">
...
<form action="j_spring_security_check" method="post">
	CPF:<input type="text" name="j_username" size="20"/><br>
	LOCALIZADOR:<input type="text" name="j_password" size="20"/><br>
	<input type="submit" value="enviar"/>
</form>

<div style="position:absolute;left:0px;top:960px;">
	<img src="resources/images/banner_rodape.gif" width="1590"/>
</div>
</body>
</html>