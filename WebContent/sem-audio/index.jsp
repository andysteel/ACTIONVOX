...
rs = stmt.executeQuery("select passageiro.cpf, passageiro.nome,passageiro.email,passageiro.telpessoal, passageiro.telcontato, bilhete.localizador,bilhete.origem,bilhete.destino,bilhete.data,bilhete.hora from passageiro inner join bilhete where bilhete.localizador='123456' and passageiro.cpf='48859204933'");
%>
...
<script type="text/javascript" src="resources/script/eventosBotao.js"></script>
	<title>confirmacao sem audio</title>
	<style type="text/css">
		...
		.bilhete{position:relative;float:top;}
...
<!--<jsp:useBean id="p" class="com.gmail.andersoninfonet.actionvox.modelo.Passageiro"/>-->
<table border="1" bgcolor="Snow" bordercolor="black" class="bilhete" align="center" width="30%">
	...
	<tr>
		<td>POLTRONA:</td><td><font color="red">A DEFINIR</font></td>
	</tr>
	<tr>
...
<br><br>
<p align="center">PARA PROSSEGUIR CLIQUE <a href="assentos-semaudio.jsp">AQUI</a> . </p>
<br><br>
