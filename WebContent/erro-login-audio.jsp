...
<script type="text/javascript" src="resources/script/eventosBotao.js"></script>
	...
	<style type="text/css">
		...
		center  {font-family:Arial Black; font-size:20px; color:rgb(0,0,102);}
	</style>
</head>
<body>
...
<div style="position:absolute;left:1247px;top:324px;">
	...
	<source src="resources/audio/Informacoes_Incorretas.mp3"/> 
	</audio>
</div>

<br><br>

<center>Erro de identificação!!!</center>

<br>

<table align="center" style="position:relative;float:top;" name="tab2">
	<tr>
		<td>
			<div id="volta" name="voltaId" onmousedown="javascript:voltaId()" >
				<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"  codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="60" height="60">
				<param name="movie" value="Voltar_identificacao.swf" />
				<param name="quality" value="high" />
				<embed src="resources/swf/Voltar_identificacao.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="400" height="400"></embed>
				</object>
			</div>
		</td>
	</tr>
